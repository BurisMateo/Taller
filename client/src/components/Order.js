                        ...
                        <div className="row">
                            {this.props.order.orders.map((order)=>(
                                <div className="col-md-12">
                                    <Card>
                                        <CardBody>
                                            <CardTitle tag="h4">{order.products.length} products - Total cost: Rs. {order.bill}</CardTitle>
                                            <div className="row">
                                            {order.products.map((product)=>(
                                                <div className="col-md-4">
                                                    <Card className="mb-2">
                                                        <CardBody>
                                                            <CardTitle tag="h5">{product.name} ({product.quantity} pieces)</CardTitle>
                                                            <CardSubtitle tag="h6">Rs. {product.price}/piece</CardSubtitle>
                                                        </CardBody>
                                                    </Card>
                                                </div>
                                            ))}
